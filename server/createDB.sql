...
CREATE TABLE recipe_ingrs (
  ingrid INTEGER PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
...
-- Populate the tables
-- All the passwords: password123
INSERT INTO users (full_name, email, password_hash) VALUES
  ('John Smith', 'john@email.com', '$2b$16$mZWqkX.rubOm.DZL42hFXu3mRzLmNK0bIrOKdB5X0JzIhNnFm2jcu'), 
...
INSERT INTO recipe_ingrs (recid, item, quantity, unit) VALUES
  (1, 'All purpose flour', 2, 'cup'),
  (1, 'Blueberries', 0.5, 'cup'),
  (1, 'Baking powder', 1.5, 'tsp'),
  (1, 'Sugar', 2, 'tbsp'),
  (1, 'Milk', 1.25, 'cup'),
  ...
  (2, 'Salt', 1.25, 'tsp'),
  (2, 'Cottage cheese (optional)', 0.5, 'cup'),
  (2, 'Egg (optional)', 1, 'none'),
  (2, 'Cranberries (optional)', 0.25, 'cup'),
  (3, 'Instant ramen noodles', 300, 'g'),
  (3, 'Shrimps, peeled', 150, 'g'),
  (3, 'Green onion', 2, 'none'),
  (3, 'Carrot', 1, 'none'),
  (3, 'Ginger, grated', 3, 'tsp'),
  (3, 'Garlic, grated', 4, 'tsp'),
  (3, 'Broth, chicken or vegetable', 2, 'cup'),
  (3, 'Water', 2, 'cup'), 
  (3, 'Sesame oil', 1, 'tbsp');
